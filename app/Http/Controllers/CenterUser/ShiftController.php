...
use App\Datatables\CenterUser\ShiftDataTable;
use App\Helpers\MyHelper;
use App\Http\Controllers\Controller;
use App\Http\Requests\CenterUser\ShiftRequest;
...
class ShiftController extends Controller
{
    ...
    public function updateOrCreate(ShiftRequest $request)
    {
        ...
        if ($item) {
            return MyHelper::responseJSON('redirect_to_home', Response::HTTP_CREATED, route('center_user.shifts.index'));
        } else {
