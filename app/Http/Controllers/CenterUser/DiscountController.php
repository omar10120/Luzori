...
use App\Datatables\CenterUser\DiscountDataTable;
use App\Helpers\MyHelper;
use App\Http\Controllers\Controller;
use App\Http\Requests\CenterUser\DiscountRequest;
...
class DiscountController extends Controller
{
    ...
    public function updateOrCreate(DiscountRequest $request)
    {
        ...
        if ($item) {
            return MyHelper::responseJSON('redirect_to_home', Response::HTTP_CREATED, route('center_user.discounts.index'));
        } else {
