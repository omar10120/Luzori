...
use App\Http\Resources\Reports\DailyReport\DailyReportResource;
...
class DailyReportController extends Controller
{
    public function daily_report(Request $request)
    {
        ...
        $data = [
            ...
            'restusers' => $restusers,
            'users_with_prices' => $users_with_prices,
            'payments_with_prices' => $payments_with_prices,
            'payments_type' => $payments_type,
            'product_details_prices' => $product_details_prices,
            'wallet_details_prices' => $wallet_details_prices,
            'users_with_commission' => $users_with_commission,
            'users_with_tips' => $users_with_tips,
            'vacationsWorkerIds' => $vacationsWorkerIds
        ];
        $data = DailyReportResource::make($data);
