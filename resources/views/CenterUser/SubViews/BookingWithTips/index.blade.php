                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="mb-1">
                                    <label for="worker_id" class="form-label">{{ __('field.worker') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <div class="mb-1">
                                    <label for="date_time" class="form-label">{{ __('field.booking_date_time') }} </label>
                                    <input type="datetime-local" id="date_time" class="form-control" name="date_time" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                <div class="mb-1">
                                    <label for="tip" class="form-label">{{ __('field.tip') }}
