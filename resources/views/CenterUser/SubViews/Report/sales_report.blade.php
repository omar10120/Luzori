...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="caption">
                <i class="fa fa-plus"></i>{{ __('locale.sales_report') }}
            </div>
        </div>
        <div class="card-body">
            <form method="get" action="{{ route('center_user.reports.sales-report') }}">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @if (isset($request) && !empty($request->has('year')))
                                <a target="_blank"
                                    href="{{ route('center_user.reports.sales-report') }}?year={{ $request->get('year') }}&month={{ $request->get('month') }}&branch_id={{ $request->get('branch_id') }}&is_pdf=true"
